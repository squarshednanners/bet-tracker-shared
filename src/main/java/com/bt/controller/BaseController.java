...
import com.bt.exception.BtException;
import com.bt.model.api.ApiMessage;
import com.bt.model.api.ApiResponse;
import com.bt.model.api.InternalActionResponse;
...
public class BaseController {
  ...
  protected void formatErrorResponse(ApiResponse<?> response, Exception e, String errorMessageCode) {
    ...
    if (e instanceof BtException) {
      for (InternalMessage message : ((BtException) e).getErrorMessages()) {
